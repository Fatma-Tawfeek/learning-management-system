        ...
        <div class="col-lg-12 mx-auto">
            <div class="card">
                <div class="card-body p-4">
                    ...
                    @endif
                    <form class="row g-3" id="myForm" action="{{ route('instructor.courses.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-3">
                            <div class="form-group col-sm-12">
                                ...
                                <img src="{{ asset('uploads/images/courses/no_image.png')}}" name="image" id="showImage" alt="course" class="rounded-circle p-1 bg-primary mt-2" width="80" height="80">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="form-group col-sm-12">
                        ...
                        <div class="mb-3 col-sm-6">
                            ...
                            <select class="form-select mb-3" aria-label="Default select example" name="label">
                                ...
                                <option value="begninner">Begninner</option>
                        ...
                        <div class="row mb-3">
                            <div class="form-group col-sm-12">
                                ...
                                <textarea class="form-control" id="myeditorinstance" name="description" rows="3"></textarea>
                            </div>
                        </div>
                        <p>Course Goals</p> 
                        <!--   //////////// Goal Option /////////////// -->
                        ...
                        <div class="col-sm-6">
                            <div class="form-check-primary form-check form-switch">
                                ...
                                type="checkbox" 
                                value="1"
                                name="have_certification"
                                id="have_certification"  
                                style="transform: scale(1.5);"
                              >
                              <label for="have_certification" class="col-form-label text-lg">Have Certification</label>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-check-primary form-check form-switch">
